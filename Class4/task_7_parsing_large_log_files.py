...
input_file = "task_4_file_path.log"  # Вкажіть шлях до вашого лог-файлу
output_file = "task_7_errors_for_analitics.log"  # Вкажіть шлях для зберігання рядків з помилками
